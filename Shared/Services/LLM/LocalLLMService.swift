...
final class LocalLLMService {
    ...
    /// Builds a non-streaming chat completion request for fixing raw dictation text.
    ...
    func fixTranscription(transcript: String, model: String) async throws -> String {
        ...
        request.httpBody = try JSONSerialization.data(withJSONObject: [
            ...
            "temperature": 0.2,
            "messages": [
                ["role": "system", "content": DictationCleanupPrompt.system],
    ...
    static func buildRequestBody(
        ...
        chatBody(
            model: model,
            systemPrompt: FormatPrompt.system(for: format),
    ...
    static func buildEditRequestBody(
        ...
        chatBody(
            model: model,
            systemPrompt: EditPrompt.system(for: format),
    ...
    static func buildAppendRequestBody(
        ...
        chatBody(
            model: model,
            systemPrompt: AppendPrompt.system(for: format),
