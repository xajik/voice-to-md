...
final class AgentSessionController: ObservableObject {
    ...
    func startSession() async {
        ...
        vtmdLog("SESSION", "Starting session")
        transcript = ""
        document = ""
        volatileText = ""
        error = nil
        ...
        var newSession = VTMDSession(modelSize: .base, baseDir: fileManager.vtmdRoot, format: outputFormat)
        ...
        do {
            ...
            vtmdLog("SESSION", "Ready: doc=\(newSession.docPath.path)")
